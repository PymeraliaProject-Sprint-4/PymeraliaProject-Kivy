...
def CreateDB():
    ...
    cursor.execute('CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, nick_name TEXT NOT NULL, email TEXT NOT NULL, phone TEXT NOT NULL)')
